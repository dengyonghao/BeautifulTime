...
//        else
//        {
//            SKYLog(@"interface4:%@, interface6:%@", [[NSString alloc] initWithData:interface4 encoding:NSUTF8StringEncoding], [[NSString alloc] initWithData:interface6 encoding:NSUTF8StringEncoding]);
//        }
...
//                int ret = getsockname(9, (struct sockaddr *)&addrMy, (socklen_t *)&leng);
////                NSLog(@"%d", ret);
            }
		}
