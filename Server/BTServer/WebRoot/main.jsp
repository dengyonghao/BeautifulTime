		...
		<script type="text/javascript">
			$(function() {
				...
				$("#doAdd").click(function() {
					...
					location.href = "addorderAction.action?sids=" + s;
				});
				...
				$("#order").click(function() {
					...
					location.href = "viewOrderAction.action";
				});
			});
	...
	<body>
		<div id="rightStyle">
			...
			<ul class="tableFrameBtn">
				<li style="width: 65%;">
					<font size="4px">欢迎你:<s:property value="%{#session.longinUser.stu_name}"></s:property>,请选择你要订购的教材,重复订购的以最后一次为准.</font>
				</li>
				<li style="width: 65%;">
					<font size="4px">前三本是全部学生需要购买的, 最后两本是java班的, ERP班的购买全部, .net班只需要购买前三本</font>
				</li>
			</ul>
			<ul class="tableFrameBtn">
			...
			<input type="button" class="inputBtn" id="order" name="addBtn"
							value="查看已购买" />
