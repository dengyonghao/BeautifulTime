...
static void CFReadStreamCallback(CFReadStreamRef stream, CFStreamEventType type, void *pInfo)
{
	@autoreleasepool {
		...
		switch(type)
		{
			...
			{
				LogVerbose(@"CFReadStreamCallback - Open");
				break;
			}
			...
			case kCFStreamEventEndEncountered:
			{
				...
				dispatch_async(asyncUdpSocket->socketQueue, ^{ @autoreleasepool {
					...
					LogVerbose(@"CFReadStreamCallback - %@",
			...
			default:
			{
				LogError(@"CFReadStreamCallback - UnknownType: %i", (int)type);
			}
		}
	}
}
...
static void CFWriteStreamCallback(CFWriteStreamRef stream, CFStreamEventType type, void *pInfo)
{
	@autoreleasepool {
		...
		switch(type)
		{
			case kCFStreamEventOpenCompleted:
			{
				LogVerbose(@"CFWriteStreamCallback - Open");
				break;
			}
			...
			case kCFStreamEventEndEncountered:
			{
				...
				dispatch_async(asyncUdpSocket->socketQueue, ^{ @autoreleasepool {
					...
					LogVerbose(@"CFWriteStreamCallback - %@",
					             (type == kCFStreamEventErrorOccurred) ? @"Error" : @"EndEncountered");
			...
			default:
			{
				LogError(@"CFWriteStreamCallback - UnknownType: %i", (int)type);
			}
		}
	}
}
