...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [deleteButton setImage:[UIImage resizedImage:@"compose_emotion_delete"] forState:UIControlStateNormal];
        [deleteButton setImage:[UIImage resizedImage:@"compose_emotion_delete_highlighted"] forState:UIControlStateHighlighted];
